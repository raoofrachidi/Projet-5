"""Module that groups the methods of the main menu
"""
from sql import data_init
from functions import validate_entering, menu_choice_product, menu_favorite
...
class ChoiceMenu:
    ...
    def product_poster():
        ...
        if not list_best_product_grade:
            print('Votre produit a le meilleur grade dans la base de données')
            ...
            if list_best_product_grade[choice_subs][1][5] is not None:
                print("-------------------------------------------------------")
                print(f"Disponible dans le(s) magasin(s) suivants : ")
